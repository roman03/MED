  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container-fluid">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
			 ...
			 <form class="navbar-form navbar-left" type='search' action="Search"  method='GET'>
       ...
       <form class="navbar-form navbar-right" id="logoutForm" action="j_spring_security_logout"  method='POST'>
     		<input type="hidden" 
